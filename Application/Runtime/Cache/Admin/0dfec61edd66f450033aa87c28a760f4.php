...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="/tpshop/Application/Public/css/User_Login.css" type="text/css" rel="stylesheet" />
        ...
        <div id="user_login">
            <dl>
                <dd id="user_top">
                    ...
                    <form action="/tpshop/index.php/admin/manage/manage" method="post">
                        <ul>
                                ...
                                <div class="user_main_box">
                                    ...
                                    <ul>
                                        ...
                                        <li class="user_main_input">
                                            ...
                                            <img src="/tpshop/Application/Public/images/admin.png"  alt="" />
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="user_main_r">
                                ...
                                <input style="border: medium none; background: url('/tpshop/Application/Public/images/user_botton.gif') repeat-x scroll left top transparent; height: 122px; width: 111px; display: block; cursor: pointer;" value="" type="submit">
                            </li>
                        </ul>
                    </form>
